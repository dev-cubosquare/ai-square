...
export const products: Product[] = [
  {
    ...
    icon: 'MessageSquare',
    landingPageUrl: 'https://staging.csqr.app',
  ...
  },
  {
    ...
    icon: 'Users',
    landingPageUrl: 'https://ai-recruit.csqr.app',
  ...
  },
  {
    ...
    icon: 'Phone',
    landingPageUrl: 'https://ai-call.csqr.app',
  ...
  },
  {
    ...
    icon: 'Sparkles',
    // No landingPageUrl - will show "Coming Soon" toast
    category: 'creative',
  ...
  },
  {
    ...
    icon: 'Workflow',
    // landingPageUrl: 'https://stagin.csqr.app',
    category: 'automation',
